...
//       name={name}
//       render={(renderProps) => (
//         <ControlledFileUploader name={name} {...props}  {...renderProps} />
//       )}
//     />
//   );
// }
...
export default function FileUploader({ control, ...props }: IFieldProps) {
    return (
        <Controller
            control={control}
            name={props.name}
            render={(renderProps) => (
                <ControlledFileUploader {...props}  {...renderProps} />
            )}
        />
    );
}